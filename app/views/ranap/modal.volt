        ...
        <div class="row">
            <div class="col-sm-4">
				...
				<div class="form-group form-group-default form-group-default-select2">
                    ...
                    <select class="full-width" data-placeholder="Pilih Propinsi" data-init-plugin="select2" name="cmbpropinsi">
                        <optgroup>
                            <option value=""></option>
            ...
            <div class="col-sm-4">
                <div class="form-group form-group-default form-group-default-select2">
                    ...
                    <select class="full-width" data-placeholder="Pilih Kota" data-init-plugin="select2" name="cmbkota">
                        <optgroup>
                            <option value=""></option>
                            <option value="TK">TK</option>
                            <option value="SD">SD</option>
                ...
                <div class="form-group form-group-default form-group-default-select2">
                    ...
                    <select class="full-width" data-placeholder="Pilih Kecamatan" data-init-plugin="select2" name="cmbkecamatan">
                        <optgroup>
                            <option value=""></option>
                            <option value="TK">TK</option>
                            <option value="SD">SD</option>
            ...
            <div class="col-sm-4">
                <div class="form-group form-group-default form-group-default-select2">
                    ...
                    <select class="full-width" data-placeholder="Pilih Kelurahan" data-init-plugin="select2" name="cmbkelurahan">
                        <optgroup>
                            <option value=""></option>
                            <option value="TK">TK</option>
                            <option value="SD">SD</option>
