...
{% block content %}
          ...
          <nav class="secondary-sidebar padding-30" style="height:100%" id="nav">
			...
			<center><label>POLI KEBIDANAN</label></center>
	...
	$(document).ready(function(){
		$("#btninput").off("click").on("click", function(e){
			...
			}else if (document.getElementById("btninput").value == "linkcatatan")
			{
				...
				var tes = '<div class="card card-transparent">\
					<div class="card-header">\
						<div class="card-title"><h5><b>PENGKAJIAN AWAL DOKTER OBGYN</b></h5>\
						</div>\
					</div>\
					<div class="card-block">\
						<div id="kotak">\
							...
							<div class="row">\
								<div class="card-header">\
									<div class="card-title"><h5><b>KAJIAN OBGYN</b></h5>\
									</div>\
								</div>\
								<div class="col-sm-6">\
									<div class="form-group form-group-default required">\
							...
							<div class="row">\
								...
								<div class="col-sm-12">\
									<div class="card-header">\
										<div class="card-title">Tindakan RS\
										</div>\
									</div>\
									<div class="form-group form-group-default input-group">\
										<span class="input-group-addon"><i class="fa fa-instagram"></i></span>\
